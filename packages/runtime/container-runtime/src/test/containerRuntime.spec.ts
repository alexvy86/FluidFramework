	...
	describe("Container Runtime", () => {
		...
		describe("Signal Telemetry", () => {
			...
			describe("processSignalForTelemetry", () => {
				...
				type EventDetailsHelperType = Record<string, string | number | boolean | undefined | (string | number | boolean)[]>;
				...
				it("should report signal latency when roundtrip signal is received", () => {
					...
					assert.ok(
						(mockLogger.events()[0].details as EventDetailsHelperType).duration as number >= 490 &&
							(mockLogger.events()[0].details as EventDetailsHelperType).duration as number <= 510,
